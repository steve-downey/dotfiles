...
rm -rf infra/
cd main/
cmake -DCMAKE_INSTALL_PREFIX=~/install/llvm-22/   -DCMAKE_BUILD_TYPE=Release -DLLVM_ENABLE_ASSERTIONS=Off  -DLLVM_PARALLEL_COMPILE_JOBS=12 -DLLVM_PARALLEL_LINK_JOBS=1 -DCMAKE_CXX_COMPILER=clang++-21 -DCMAKE_C_COMPILER=clang-21  -DLLVM_ENABLE_PROJECTS="clang;clang-tools-extra;lld;lldb;libc;libclc;mlir;flang" -DLLVM_ENABLE_RUNTIMES="libcxx;libcxxabi;compiler-rt;libunwind"  -DLLVM_BUILD_BENCHMARKS=Off -DLLVM_INCLUDE_BENCHMARKS=On  -DLLVM_ENABLE_BINDINGS=Off -DBENCHMARK_DOWNLOAD_DEPENDENCIES=On -DCMAKE_BUILD_TYPE=Release -DCLANG_ENABLE_BOOTSTRAP=on -DCLANG_BOOTSTRAP_PASSTHROUGH="CMAKE_INSTALL_PREFIX;CMAKE_VERBOSE_MAKEFILE"  -G Ninja  ../main/llvm
emacs-31 --init-directory=.emacs.d/
